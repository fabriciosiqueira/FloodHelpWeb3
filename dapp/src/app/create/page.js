        ...
        <div className="ps-5">
            ...
            <div className="col-6">
                <div className="form-floating mb-3">
                    ...
                    <label htmlFor="description">Descreva em detalhes o que precisa e onde você está (para entregas presencias):</label>
                </div>
            </div>
            <div className="col-6">
                <div className="form-floating mb-3">
            ...
            <div className="col-6">
                <div className="form-floating mb-3">
                    ...
                    <label htmlFor="goal">Meta em BNB (deixe em branco caso não deseje receber doação em crypto):</label>
                </div>
            </div>
            <div className="row">
